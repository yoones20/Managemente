...
class MainWindow(QWidget):
    ...
    def insert_data(self, table_name, data):
        ...
        if query.exec_():
            ...
            self.show_data()  # Refresh the table after insert
        else:
    ...
    def edit_teache(self):
        ...
        if selected_row >= 0:
            ...
            if ok_name and ok_number_class and ok_time_class:
                ...
                query.addBindValue(self.teache_table.item(selected_row, 0).text())  # The ID of the selected row

                if query.exec_():
                    print("Data updated successfully.")
                    self.show_data()  # Refresh the table after update
                else:
...
def delete_teache(self):
        ...
        if selected_row >= 0:
            ...
            if query.exec_():
                ...
                self.show_data()  # Refresh the table after delete
            else:
